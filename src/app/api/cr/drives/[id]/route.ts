...
import { addToRoster, refundContribution, remindDefaulters, removeFromRoster, setDriveStatus, settleDrive } from "@/db/organizer";
...
const Body = z.object({
  action: z.enum(["roster_add", "roster_remove", "status", "refund", "settle", "remind"]),
